...
*@author Mahmoodah Jaffer - The code used for the prime number test was modified from: https://www.javatpoint.com/prime-number-program-in-java
*@since 28 March 2019
*/

/**
HashFunction class stores the powerstation object in a hash table so that  it can be easily found
Uses: linear probing, quadratic and chaining collision schemes
*/	
...
public class HashFunction{
	...
	*/
	...
	@exception IOException if stream to file cannot be written to
	@exception FileNotFoundException if file does not exist
	@see IOException if stream to file cannot be written to
	@see FileNotFoundException
	*/
